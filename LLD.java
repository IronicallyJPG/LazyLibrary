...
public class LLD {
	...
	public String getTimeOfDayInDate_24Hour() {
		return this.time;
	}
	
	// =============================================================//
	// Returns 24Hour_time as STRING, not an int or float.
	public String getTimeOfDayInDate_12Hour() {
		DateFormat newtime = new SimpleDateFormat("kk:mm aa");
		DateFormat outputformat = new SimpleDateFormat("hh:mm aa");
		Date date = null;
		String output = null;
		try {
			// Conversion of input String to date
			date = newtime.parse(this.timeWithAMPM);
