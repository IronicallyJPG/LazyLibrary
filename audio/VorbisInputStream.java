...
public class VorbisInputStream extends InputStream {
	...
	/**
	 * @param source
	 *            the instance of {@linkplain VorbisStream} to wrap
	 * @since 1.2.2
	 */
	...
	/**
	 * @return the {@linkplain AudioFormat} of the wrapped
	 *         {@linkplain VorbisStream}.
	 * @since 1.2.2
	 */
	public AudioFormat getAudioFormat() {
		
		return new AudioFormat(this.source.getIdentificationHeader().getSampleRate(), 16, this.source.getIdentificationHeader().getChannels(), true,
				true);
	}
}
